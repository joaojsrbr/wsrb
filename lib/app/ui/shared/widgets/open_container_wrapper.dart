...
class OpenContainerWrapper<T> extends OpenContainer<T> {
  ...
  static void closedContainer(BuildContext context) =>
      _OpenContainerInherited.of(context).closedContainer?.call();
}
...
class _OpenContainerInherited extends InheritedWidget {
  ...
  static _OpenContainerInherited? maybeOf(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<_OpenContainerInherited>();
