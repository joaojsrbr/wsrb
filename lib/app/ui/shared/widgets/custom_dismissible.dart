...
class CustomDismissible extends StatefulWidget {
  ...
  @override
  State<CustomDismissible> createState() => CustomyDismissibleState();
}
...
class CustomyDismissibleState extends State<CustomDismissible>
  ...
  void initState() {
    ...
    //   ..addListener(() {
    //     print(_elevationAnimation?.value);
    //     if (mounted) setState(() {});
    //   });
  }
  ...
  void dispose() {
    _moveController
      ...
      ..removeListener(_handleDismissUpdateValueChanged)
      ..dispose();
...
class DismissibleAnimation extends InheritedWidget {
  ...
  bool updateShouldNotify(DismissibleAnimation oldWidget) =>
      moveAnimation.value != oldWidget.moveAnimation.value ||
      moveAnimation.isDismissed != oldWidget.moveAnimation.isDismissed ||
  ...
  RRect getClip(Size size) {
    switch (axis) {
      case Axis.horizontal:
        ...
        if (offset < 0) {
          if (_currentRadius != 0 && size.width <= (offset.abs() + 1)) {
            _currentRadius--;
          } else if (_currentRadius != radius) {
            _currentRadius++;
          }
        ...
        if (_currentRadius != 0 && size.width <= (offset + 1)) {
          _currentRadius--;
        } else if (_currentRadius != radius) {
          _currentRadius++;
        }
      ...
      case Axis.vertical:
        ...
        if (offset < 0) {
          return RRect.fromLTRBR(0.0, size.height + offset, size.width,
              size.height, Radius.circular(radius));
        }
        return RRect.fromLTRBR(
            0.0, 0.0, size.width, offset, Radius.circular(radius));
    }
  }
