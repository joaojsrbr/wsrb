...
class ReleaseChips extends StatefulWidget {
  const ReleaseChips({super.key, required this.content});

  final Content? content;

  @override
  State<ReleaseChips> createState() => _ReleaseChipsState();
}

class _ReleaseChipsState extends State<ReleaseChips> {
  List<int> _totalPage = [];
  ...
  @override
  void didUpdateWidget(covariant ReleaseChips oldWidget) {
