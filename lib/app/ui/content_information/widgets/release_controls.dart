...
class ReleaseControls extends StatefulWidget {
  ...
  @override
  State<ReleaseControls> createState() => _ReleaseControlsState();
}

class _ReleaseControlsState extends State<ReleaseControls> {
  List<int> _totalPage = [];
  ...
  @override
  void didUpdateWidget(covariant ReleaseControls oldWidget) {
