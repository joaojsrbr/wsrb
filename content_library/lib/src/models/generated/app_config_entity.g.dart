...
const AppConfigEntitySchema = CollectionSchema(
  ...
  properties: {
    r'autoUpdateInterval': PropertySchema(
      id: 0,
      name: r'autoUpdateInterval',
      type: IsarType.byte,
      enumMap: _AppConfigEntityautoUpdateIntervalEnumValueMap,
    ),
...
void _appConfigEntitySerialize(
  ...
  writer.writeByte(offsets[0], object.autoUpdateInterval.index);
...
AppConfigEntity _appConfigEntityDeserialize(
  ...
  final object = AppConfigEntity(
    autoUpdateInterval: _AppConfigEntityautoUpdateIntervalValueEnumMap[
...
P _appConfigEntityDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_AppConfigEntityautoUpdateIntervalValueEnumMap[
              reader.readByteOrNull(offset)] ??
          AutoUpdateInterval.disabled) as P;
    case 1:
...
const _AppConfigEntityautoUpdateIntervalEnumValueMap = {
  'disabled': 0,
  'every15Minutes': 1,
  'every30Minutes': 2,
  'every12Hours': 3,
...
const _AppConfigEntityautoUpdateIntervalValueEnumMap = {
  0: AutoUpdateInterval.disabled,
  1: AutoUpdateInterval.every15Minutes,
  2: AutoUpdateInterval.every30Minutes,
  3: AutoUpdateInterval.every12Hours,
  4: AutoUpdateInterval.daily,
  5: AutoUpdateInterval.every2Days,
  6: AutoUpdateInterval.every3Days,
  7: AutoUpdateInterval.weekly,
};
...
extension AppConfigEntityQueryFilter
  ...
  QueryBuilder<AppConfigEntity, AppConfigEntity, QAfterFilterCondition>
      autoUpdateIntervalEqualTo(AutoUpdateInterval value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'autoUpdateInterval',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<AppConfigEntity, AppConfigEntity, QAfterFilterCondition>
      autoUpdateIntervalBetween(
    AutoUpdateInterval lower,
    AutoUpdateInterval upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension AppConfigEntityQuerySortBy
  ...
  QueryBuilder<AppConfigEntity, AppConfigEntity, QAfterSortBy>
      sortByAutoUpdateInterval() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'autoUpdateInterval', Sort.asc);
    });
  }

  QueryBuilder<AppConfigEntity, AppConfigEntity, QAfterSortBy>
      sortByAutoUpdateIntervalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'autoUpdateInterval', Sort.desc);
    });
  }
...
extension AppConfigEntityQueryWhereDistinct
  ...
  QueryBuilder<AppConfigEntity, AppConfigEntity, QDistinct>
      distinctByAutoUpdateInterval() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'autoUpdateInterval');
    });
  }
...
extension AppConfigEntityQueryProperty
  ...
  QueryBuilder<AppConfigEntity, AutoUpdateInterval, QQueryOperations>
      autoUpdateIntervalProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'autoUpdateInterval');
    });
  }
