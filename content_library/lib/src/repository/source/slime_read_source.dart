...
class SlimeReadSource extends RSource {
  ...
  Future<bool> loadData() async {
    ...
    try {
      ...
      final SlimeReadBookResponse responseDto =
          SlimeReadBookResponse.fromJson(response.data);
      ...
      customLog(_.message, stackTrace: __);
      contentRepository.isSuccess = false;
      contentRepository._hasMore = false;
      return Future.value(false);
    } on Exception catch (_, __) {
      customLog(_.toString(), stackTrace: __);
      contentRepository.isSuccess = false;
      contentRepository._hasMore = false;
      return Future.value(false);
    } finally {
