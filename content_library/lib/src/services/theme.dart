...
class MaterialTheme {
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryFixedDim: Color(0xff6b5473),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff3d5f90),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff1e4372),
      onPrimaryContainer: Color(0xffffffff),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      primaryFixedDim: Color(0xffa6c8ff),
      onPrimaryFixedVariant: Color(0xff0c3765),
      secondaryFixed: Color(0xffd9e3f8),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(0xffdfc1e6),
      onTertiaryContainer: Color(0xff000000),
      ...
      tertiaryFixedDim: Color(0xffdfc1e6),
